...
- Planificador conectado al PDF: el selector `Elemento` permite anadir entradas del Pla d'Espais como bloques editables en planta, con m2 brutos aproximados, capacidad esperada y componentes internos.
- Componentes internos por sala: el inspector permite ver, anadir, editar y quitar subcomponentes funcionales como habitaciones, boxes, controles de enfermeria, zonas limpio/sucio, AGV, almacenes, CPD o salas blancas.
