...
- Paneles laterales contextuales: Planificador y Simulacion permiten ocultar/mostrar panel izquierdo y derecho desde la barra superior para trabajar a pantalla mas limpia.
